        ...
        <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                >
                    ...
                    <button
                        class="toggle-spam relative bg-gray-100 hover:bg-gray-200
                    ...
                    >
                        ...
                        >
                            <li><a oncClick="return false;" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark As Spam</a></li>
                            <li><a oncClick="return false;" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                        </ul>
                    </button>
                </div>
