<div class="idea-and-buttons container">
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div id="post-comment-section" class="relative">
                <button
                    type="button"
                ...
                <div
                    ...
                    class="hidden absolute z-10 w-64 md:w-104 text-left font-semibold
            ...
            <div id="set-status-section" class="relative">
                ...
                <div
                    id="set-status-form"
                    class="hidden absolute z-20 w-64 md:w-76
                    text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                        ...
                        <textarea name="update_comment" id="update_comment" cols="30" rows="3"
                                  class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-9000 border-none px-4 py-2"
